...
module.exports=function(ctx,cookie,appTime,meetTime) {
  const options = {
    ...
    form: {
      'geturl': `/query.action?obj=a55&m=newpage&ffe201201985874qTZS4_lkid=a5120178E925802a0G6C&ffe201201985874qTZS4=326会议室（立思辰大厦)&ffe2012005369413Ogl4=${meetTime}&rtnURL=%2Fcontroller.action%3Fname%3DScheduledConference`,
      'ffe201201985828so4wO': `${appTime} 00:05:00`,
      'ffe201201985874qTZS4': '326会议室（立思辰大厦)',
      'ffe201201985874qTZS4_lkid': 'a5120178E925802a0G6C',
      ...
      'token': 'N1N9MS1YRP6X6H77WZEM1ZI7JCLIT0WN',
      'id': '',
      ...
      'fieldList': '',
      'lkValue': '{ffe201201985849UOmjV:\'中文未来\',ffe201201985849UOmjV_lkid:\'\',ffe2012019848730zNik:\'范占鳌\',ffe2012019848730zNik_lkid:\'005201888A301F7OYLmi\',ffe201201985874qTZS4:\'326会议室（立思辰大厦)\',ffe201201985874qTZS4_lkid:\'a5120178E925802a0G6C\',ffe201203093577hx3Sm:\'范占鳌\',ffe201203093577hx3Sm_lkid:\'005201888A301F7OYLmi\'}',
      'jsonlist': '[]',
      'ylgxjsonlist': '[]',
      'jsonMasterlist': '[]',
      'lkmutiValue': '{}',
      ...
      'entity.lookupField1': '',
      'entity.ownerid': '005201888A301F7OYLmi',
      'entity.lookupField2': 'a5120178E925802a0G6C',
  ...
  request(options, function (error, response) {
    ctx.logger.info('params:326发送请求')
    if (error) {
      throw new Error(error)
    }else{
      fs.writeFile('index326.html',response.body,function(err,data) {
      })
    }
