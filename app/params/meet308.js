...
module.exports=function(ctx,cookie,appTime,meetTime) {
  var options = {
    ...
    form: {
      'geturl': `/query.action?obj=a55&m=newpage&ffe201201985874qTZS4_lkid=a512017700C768AKZytl&ffe201201985874qTZS4=308会议室（立思辰大厦）&ffe2012005369413Ogl4=${meetTime}&rtnURL=%2Fcontroller.action%3Fname%3DScheduledConference`,
      'ffe201201985828so4wO': `${appTime} 00:05:00`,
      'ffe201201985874qTZS4': '308会议室（立思辰大厦）',
      'ffe201201985874qTZS4_lkid': 'a512017700C768AKZytl',
      ...
      'ffe201201985908pwO5x': `${meetTime} 21:00:00`,
      ...
      'token': '6GYFOONX05P00PUTQJ2Q2667434QBODS',
      'id': '',
      ...
      'fieldList': '',
      'lkValue': '{ffe201201985849UOmjV:\'中文未来\',ffe201201985849UOmjV_lkid:\'\',ffe2012019848730zNik:\'范占鳌\',ffe2012019848730zNik_lkid:\'005201888A301F7OYLmi\',ffe201201985874qTZS4:\'308会议室（立思辰大厦）\',ffe201201985874qTZS4_lkid:\'a512017700C768AKZytl\',ffe201203093577hx3Sm:\'范占鳌\',ffe201203093577hx3Sm_lkid:\'005201888A301F7OYLmi\'}',
      'jsonlist': '[]',
      'ylgxjsonlist': '[]',
      'jsonMasterlist': '[]',
      'lkmutiValue': '{}',
      ...
      'entity.lookupField1': '',
      'entity.ownerid': '005201888A301F7OYLmi',
      'entity.lookupField2': 'a512017700C768AKZytl',
      'entity.timeField2': `${meetTime} 00:00:00`,
      'entity.timeField3': `${meetTime} 21:00:00`,
  ...
  request(options, function (error, response) {
    ctx.logger.info('params:308发送请求')
    if (error) {
      throw new Error(error)
    }else{
      fs.writeFile('index308.html',response.body,function(err,data) {
      })
    }
